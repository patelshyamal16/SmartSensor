...
import com.example.SmartSensor.login;
...
//        setSupportActionBar(toolbar); set the title name on the app
//        getSupportActionBar().setTitle(null); remove the title name from toolbar
        ...
        slidingRootNav = new SlidingRootNavBuilder(this)
                ...
                .withMenuLayout(R.layout.drawer_menu_activity)
                .inject();
