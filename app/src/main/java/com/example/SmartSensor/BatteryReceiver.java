...
public class BatteryReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        TextView statusLabel = ((Batterylife)context).findViewById(R.id.statusLabel);
        TextView percentageLabel = ((Batterylife)context).findViewById(R.id.percentageLabel);
        ImageView batteryImage = ((Batterylife)context).findViewById(R.id.batteryImage);
